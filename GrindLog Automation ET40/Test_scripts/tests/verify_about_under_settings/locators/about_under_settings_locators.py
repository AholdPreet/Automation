class AboutUnderSettingsLocators :
    ...
    # USB_DEBUGGINF_ALERT_LOCATOR = 'new UiSelector().text("USB debugging connected")' 
    USB_DEBUGGINF_ALERT_LOCATOR = '//android.widget.TextView[@text="USB debugging connected"]'

    ABOUT_LOCATOR = 'new UiSelector().text("About")'

    ANDROID_VERSION_LOCATOR = 'new UiSelector().text("Android Version")'
