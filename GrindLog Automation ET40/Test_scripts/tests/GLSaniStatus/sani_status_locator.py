class GrindLogSaniStatusLocator :
    ...
    SanitizationStatus_LOCATOR = '//android.widget.TextView[@text="Sanitization Status"]'

    Sani_Status_Exit_LOCATOR = '//android.widget.Button[@resource-id="ctl00_MainContent_btnExit"]'
